    ...
    return (
        <div className='mt-[100px] mx-[16px]  2xl:mt-[170px] 2xl:mx-[180px]'>
            ...
            <div className='flex flex-col mt-[50px] 2xl:mt-[40px] w-full '>
                ...
                <div className=' flex-row hidden 2xl:flex w-full gap-[35px]'>
                    {serviceItems.map((name, index) => (
                        <button
                            onClick={() => handleClick(name.id)}
                            key={index}
                            className={` pb-[10px] text-[13px]  font-bold font-manrope 2xl:text-[22px] 2xl:font-semibold ${active === name.id
                                ? 'border-b-[3px] border-[#27BEFF] text-[#27BEFF]'
                                : 'text-[#3E3E3E]'
                                }`}
                        >
                ...
                <div className='flex flex-col gap-[20px] mt-[30px] 2xl:flex 2xl:flex-row 2xl:flex-wrap 2xl:justify-between 2xl:mt-[60px]'>
                    {filteredData.map((data , index) => (
                        <div className='rounded-[15px]  border border-[#E3E3E3] py-[25px] px-[20px]  2xl:w-[32%]  2xl:pb-[60px] relative '>
