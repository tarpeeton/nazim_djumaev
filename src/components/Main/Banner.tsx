  ...
  return (
    <div className='mt-[10px] relative w-full overflow-hidden'>
        <div className='flex flex-col w-full z-[999] relative'>
            ...
            <p className=' mx-[13px] 2xl:w-[34%] 2xl:text-left 2xl:ml-[180px] 2xl:mx-0 text-center mt-[10px] text-[14px] font-semibold  text-[#686868]  2xl:text-[18px]'>Опытный бариатрический хирург с многолетней практикой. Специализируется на передовых методах хирургического лечения ожирения и смежных проблем</p>
        </div>
       ...
       <div className="w-full  absolute top-0  h-full bg-gradient-to-r rounded-lg shadow-lg from-[#9AE1FF80] to-[#6CF5DD80]"></div>
        ...
        <Image  src={NozimImage} alt='Ellipse 5' width={2300} height={3300} className='object-contain w-full  2xl:h-[500px] h-[450px] relative z-[999]'/>
          <div className='absolute bottom-0 left-0 2xl:left-1/2 2xl:transform 2xl:-translate-x-1/2'>
          <Image  src={Word} alt='Ellipse 5' width={800} height={900} className='object-contain w-full h-full'/>
          </div>
          <div className='absolute bottom-0 left-0 2xl:left-1/2 2xl:transform 2xl:-translate-x-1/2'>
          <Image  src={Word} alt='Ellipse 5' width={800} height={600} className='object-contain w-full h-full'/>
          </div>
          <div className='absolute z-[9999] bottom-[50px] flex flex-row w-full items-center gap-[20px] justify-center'>
