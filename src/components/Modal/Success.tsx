        ...
        <div>
            ...
            >
                ...
                <div className='w-full flex flex-col justify-center'>
                    <p className='2xl:text-[30px] text-[20px] mt-[20px] text-titleDark font-extrabold text-center font-manrope'>Заявка отправлена!</p>
                    <p className='font-medium w-[90%] mx-auto text-center 2xl:text-[17px] mt-[10px] text-[#686868] font-manrope'>
                    Ваша заявка успешно отправлена! В ближайшее время я свяжусь с вами
                    </p>

                    <button  className='rounded-full w-[80%]  bg-[#27BEFF] py-[15px] px-[20px]  mx-auto text-center text-[16px]  2xl:text-[18px] text-white font-bold font-manrope  mt-[30px] 2xl:mt-[40px] '>
                        Закрыть
                    </button>
                </div>
                </div>
